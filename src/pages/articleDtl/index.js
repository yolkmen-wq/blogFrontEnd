const ArticleDtl = () => {
  return (
    <div className="col-lg-8 mb-5 mb-lg-0">
      <div className="row">
        <div className="col-lg-12 mb-5 mb-lg-0" style={{marginLeft:"12px"}}>
          <article>
            <img
              loading="lazy"
              decoding="async"
              src={require("@assets/images/post/post-4.jpg")}
              alt="Post Thumbnail"
              className="w-100"
            />
            ...
            <div className="content text-left">
              ...
              <p>
                <a href="#">I&rsquo;m a reference-style link</a>
              </p>
              <p>
                <a href="#!">
              ...
              <p>
                Or leave it empty and use the <a href="#">link text itself</a>.
              </p>
              <p>
                URLs and URLs in angle brackets will automatically get turned
                into links.
                <a href="#">http://www.example.com</a> or
                <a href="#">http://www.example.com</a> and sometimes example.com
